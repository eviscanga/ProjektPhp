...
<?php foreach($menu as $m): ?>
    ...
    <input type="hidden" class="btn btn-primary" name="listItems" id="listItems"></input>
...
$(document).ready(function()
{
    ...
    var updateOutput = function(e)
    {
        ...
        let dataUpdated = window.JSON.stringify(list.nestable('serialize'));
        // console.log(dataUpdated);
        list1 = document.getElementById("listItems");
        list1.value = dataUpdated;
        console.log(dataUpdated);
    ...
    // $.each(JSON.parse(obj.value), function (index, item) {
